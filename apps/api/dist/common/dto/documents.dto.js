...
class AnchorDto {
    static _OPENAPI_METADATA_FACTORY() {
        return { documentHash: { required: true, type: () => String, pattern: "HASH_REGEX" }, documentType: { required: true, type: () => String }, recipientEmail: { required: false, type: () => String }, recipientName: { required: false, type: () => String }, issuerAddress: { required: true, type: () => String }, issuerName: { required: false, type: () => String } };
    }
}
...
__decorate([
    (0, swagger_1.ApiProperty)({ description: 'Free-form document category.', example: 'Certificate' }),
    (0, class_validator_1.IsString)(),
...
__decorate([
    (0, swagger_1.ApiProperty)({ description: 'Wallet of the issuing organization.', example: EXAMPLE_WALLET }),
    (0, class_validator_1.IsString)(),
    (0, class_validator_1.IsNotEmpty)(),
    __metadata("design:type", String)
...
class AnchorResponseDto {
    static _OPENAPI_METADATA_FACTORY() {
        return { success: { required: true, type: () => Boolean }, txHash: { required: true, type: () => String }, documentHash: { required: true, type: () => String }, timestamp: { required: true, type: () => String }, status: { required: true, type: () => String }, message: { required: true, type: () => String } };
    }
}
...
__decorate([
    (0, swagger_1.ApiPropertyOptional)({ enum: ['active', 'revoked'], example: 'active' }),
    __metadata("design:type", String)
