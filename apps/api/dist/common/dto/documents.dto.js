...
__decorate([
    (0, swagger_1.ApiProperty)({ description: 'Whether the document is anchored on-chain.', example: true }),
    __metadata("design:type", Boolean)
...
__decorate([
    (0, swagger_1.ApiPropertyOptional)({ enum: ['active', 'not_found'], example: 'active' }),
    __metadata("design:type", String)
...
__decorate([
    (0, swagger_1.ApiProperty)({ enum: ['active'], example: 'active' }),
    __metadata("design:type", String)
