...
class HealthResponseDto {
    static _OPENAPI_METADATA_FACTORY() {
        return { status: { required: true, type: () => String }, service: { required: true, type: () => String } };
    }
}
...
__decorate([
    (0, swagger_1.ApiProperty)({ example: '@certfyi/api', description: 'Identifier of the responding service' }),
    __metadata("design:type", String)
