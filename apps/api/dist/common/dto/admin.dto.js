...
class AdminDocumentsQueryDto {
    static _OPENAPI_METADATA_FACTORY() {
        return { search: { required: false, type: () => String }, cursor: { required: false, type: () => String }, limit: { required: false, type: () => String } };
    }
}
